...
<!-- Default box -->
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title" id="judul2">Form penarikan Kas</h3>
        ...
        <div class="box-body">
            ...
            <div class="col-sm-9">
                <input type="submit"  class="btn btn-success" value="Tarik Kas">
            </div>
            <div style="clear: both;"></div><br>
            </form>
            </div>
...
<script type="text/javascript">
  ...
  $("#form_penarikan_kas").on("submit",function(){
    ...
    {
      $.post("<?php echo base_url()?>index.php/laporan_keuangan/go_tarik_kas",$(this).serialize(),function(x){

        $("#info_form").html("<div class='alert alert-success'>Berhasil ditarik.</div>");
        $("#div_form").remove();
      })
    }
